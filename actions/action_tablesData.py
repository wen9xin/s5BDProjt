...
class AppTablesData(QDialog):
    ...
    def refreshAllTables(self):
        ...
        #self.refreshTable(self.ui.label_VueEquipes, self.ui.tableVueEquipes, "SELECT numEq, nbEquipiers FROM LesEquipes")
        self.refreshTable(self.ui.label_VueEquipes, self.ui.tableVueEquipes,"SELECT numEp,numSp FROM LesEquipiers ")
